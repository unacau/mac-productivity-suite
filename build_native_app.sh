...
lipo -create -output "${MACOS_DIR}/Chomyak" \
...
codesign --force --sign - --identifier "com.almosteleven.chomyak" -r="designated => identifier \"com.almosteleven.chomyak\"" "${APP_BUNDLE}"
...
echo " App: ${APP_BUNDLE}"
echo " DMG: ${DMG_PATH}"
echo " Archs: $(lipo -archs "${MACOS_DIR}/Chomyak")"
echo "=================================================="
