...
```mermaid
graph TD
    A["<b>Sensory-Motor System</b><br/>Axonometric keycap monolith, 30° isometric plane, tactile affordances, mirror neuron activation"] <--> B["<b>Emotion-Valuation System</b><br/>Kandinsky primary triad, geometric Kindchenschema, mOFC dopaminergic reward"]
    B <--> C["<b>Knowledge-Meaning System</b><br/>Bauhaus functionalism, industrial honesty, cultural inversion from meme to precision instrument"]
    C <--> A
```
